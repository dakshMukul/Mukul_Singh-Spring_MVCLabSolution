...
<body>
	...
	<div class="container">
		...
		<form action="/CollageFest/students/search" class="form-inline">

			<!-- Add a button -->
			<a href="/CollageFest/students/showFormForAdd"
				...
				<c:forEach items="${Students}" var="tempStudent">
					<tr>
						...
						<td>
							...
							href="/CollageFest/students/showFormForUpdate?studentId=${tempStudent.id}"
							class="btn btn-info btn-sm"> Update </a> <!-- Add "delete" button/link -->
							<a href="/CollageFest/students/delete?studentId=${tempStudent.id}"
